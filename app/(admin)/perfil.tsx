      ...
      <ScrollView contentContainerStyle={styles.container}>
        <View style={styles.header}>
          <View style={styles.avatarWrap}>
            <Text style={styles.avatarText}>{getIniciales(state.user?.name ?? 'AD')}</Text>
          </View>
          <Text style={styles.name}>{state.user?.name ?? 'Administrador'}</Text>
          <Text style={styles.role}>{state.user?.role?.toUpperCase() ?? 'ADMIN'}</Text>
        </View>
